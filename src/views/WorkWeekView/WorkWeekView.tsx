...
const WorkWeekView = ({
  ...
  const days = [...Array(5)].map((_, i) => addDays(start, i));

  return (
    <div>
      <div className="grid grid-cols-5 gap-1 mb-1 text-center font-bold text-white bg-gradient-to-r from-indigo-500 to-cyan-500 p-2 rounded">
        {days.map((day, index) => (
